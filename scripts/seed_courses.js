 ...
 * Run with backend running: node scripts/seed_courses.js
 */
...
// ── Course definitions ──
const courseDefs = [
  { sub:'Web Development', name:'Complete HTML & CSS Bootcamp', desc:'Master modern web development from scratch with HTML5 and CSS3.', brief:'Learn HTML & CSS from zero to hero.', price:2999, discount:15, instructor:'Sarah Johnson', diff:1, learns:['Write semantic HTML5','Master CSS Grid and Flexbox','Build responsive layouts','Create animations with CSS','Deploy static websites'], reqs:['Any computer with internet','No prior coding experience needed'] },
  { sub:'Web Development', name:'React.js - The Complete Guide', desc:'Dive deep into React.js including Hooks, Redux, React Router and Next.js.', brief:'Master React.js from fundamentals to advanced patterns.', price:5999, discount:20, instructor:'Max Schwarzmuller', diff:2, learns:['React Hooks in depth','State management with Redux','Client-side routing','Server-side rendering with Next.js','Testing React components'], reqs:['JavaScript ES6 knowledge','Basic HTML and CSS'] },
  { sub:'Web Development', name:'Node.js and Express MasterClass', desc:'A complete backend development course using Node.js, Express, databases and deployment.', brief:'Learn backend development using Node.js.', price:4999, discount:18, instructor:'Andrew Mead', diff:2, learns:['Node.js fundamentals','Build REST APIs using Express','Work with databases','Implement authentication','Deploy backend applications'], reqs:['Basic JavaScript knowledge','Laptop with Node.js installed'] },
  { sub:'Mobile Development', name:'Flutter & Dart - The Complete Guide', desc:'Build beautiful cross-platform mobile apps with Flutter and Dart.', brief:'Create iOS and Android apps with a single codebase.', price:4499, discount:15, instructor:'Academind', diff:1, learns:['Dart programming language','Flutter widget system','State management','Navigation and routing','Publishing to app stores'], reqs:['Basic programming knowledge','Computer with 8GB RAM'] },
  { sub:'Mobile Development', name:'iOS App Development with Swift', desc:'Learn iOS development with Swift, SwiftUI and Core Data.', brief:'Build professional iOS apps from scratch.', price:5499, discount:17, instructor:'Angela Yu', diff:2, learns:['Swift programming','SwiftUI framework','Core Data persistence','Networking and APIs','App Store submission'], reqs:['Mac computer required','No prior iOS experience needed'] },
  { sub:'Data Science', name:'Python for Data Science & AI', desc:'Learn Python programming for data analysis, visualization and machine learning.', brief:'Master Python for data science applications.', price:3999, discount:0, instructor:'IBM Skills Network', diff:1, learns:['Python fundamentals','NumPy and Pandas','Data visualization with Matplotlib','Basic machine learning','Jupyter Notebooks'], reqs:['No prior programming experience','Basic math knowledge'] },
  { sub:'Data Science', name:'Machine Learning A-Z', desc:'Master machine learning algorithms including regression, classification and deep learning.', brief:'Comprehensive machine learning course.', price:6999, discount:20, instructor:'Kirill Eremenko', diff:3, learns:['Supervised learning algorithms','Unsupervised learning','Model evaluation','Feature engineering','Deep learning basics'], reqs:['Python programming skills','Basic statistics knowledge'] },
  { sub:'Finance', name:'The Complete Financial Analyst Course', desc:'Learn financial analysis, accounting, valuation and Excel modeling.', brief:'Become a professional financial analyst.', price:3499, discount:15, instructor:'Frank Kane', diff:2, learns:['Financial statement analysis','Excel financial modeling','Business valuation methods','Capital budgeting','Risk management'], reqs:['Basic Excel skills','Interest in finance'] },
  { sub:'Finance', name:'Stock Market Investing for Beginners', desc:'Learn how to invest in stocks, build a portfolio and understand fundamentals.', brief:'Start investing in the stock market.', price:1999, discount:10, instructor:'Steve Ballinger', diff:1, learns:['Stock market fundamentals','Portfolio diversification','Technical analysis basics','Reading financial statements','Risk management strategies'], reqs:['No prior investing knowledge','Basic math skills'] },
  { sub:'Marketing', name:'Digital Marketing Masterclass', desc:'Master SEO, social media marketing, Google Ads, email marketing and analytics.', brief:'Complete guide to digital marketing strategies.', price:3999, discount:18, instructor:'Daragh Walsh', diff:1, learns:['SEO optimization','Google Ads campaigns','Social media strategy','Email marketing automation','Analytics and reporting'], reqs:['No prior marketing experience','Computer with internet access'] },
  { sub:'Marketing', name:'Content Marketing & Copywriting Pro', desc:'Learn to create compelling content and copy that drives conversions.', brief:'Master content marketing and copywriting.', price:2999, discount:12, instructor:'Gary Halbert', diff:2, learns:['Content strategy development','SEO content writing','Email copywriting','Landing page optimization','Brand storytelling'], reqs:['Good English writing skills','Basic marketing understanding'] },
  { sub:'UI/UX Design', name:'UI/UX Design Bootcamp', desc:'Learn user interface and user experience design using Figma.', brief:'Master UI/UX design from research to prototyping.', price:4499, discount:18, instructor:'Jose Portilla', diff:2, learns:['Design thinking process','Wireframing and prototyping','Figma mastery','User research methods','Design system creation'], reqs:['No design experience needed','Computer with Figma installed'] },
  { sub:'UI/UX Design', name:'Mobile App Design from Scratch', desc:'Design beautiful and functional mobile applications for iOS and Android.', brief:'Learn mobile-first design principles.', price:3499, discount:15, instructor:'Daniel Walter', diff:1, learns:['Mobile design patterns','iOS and Android guidelines','Interactive prototypes','Micro-interactions','Design handoff to developers'], reqs:['Basic computer skills','Interest in mobile design'] },
  { sub:'Graphic Design', name:'Graphic Design Masterclass', desc:'Learn graphic design theory and practical skills using Adobe Creative Suite.', brief:'Become a professional graphic designer.', price:3999, discount:0, instructor:'Lindsay Marsh', diff:1, learns:['Color theory and typography','Logo and brand design','Print design layouts','Digital illustration','Portfolio creation'], reqs:['No prior design experience','Access to Adobe Creative Suite'] },
  { sub:'Graphic Design', name:'Adobe Photoshop - Beginner to Pro', desc:'Master Adobe Photoshop from basic tools to advanced compositing.', brief:'Complete Photoshop course for all levels.', price:4499, discount:15, instructor:'Daniel Scott', diff:2, learns:['Photoshop workspace mastery','Photo retouching techniques','Layer masks and compositing','Digital painting','Batch processing and automation'], reqs:['Adobe Photoshop installed','No prior Photoshop experience'] },
];
...
(async () => {
  ...
  for (let i = 0; i < courseDefs.length; i++) {
    ...
    const payload = { courseName:c.name, description:c.desc, briefDescription:c.brief, price:c.price, discount:c.discount, instructorName:c.instructor, categorytoken:t.categorytoken, subcategorytoken:t.subcategorytoken, difficultyId:c.diff, learningPoints:c.learns, requirements:c.reqs, sections:buildSections(c.sub) };
    try {
